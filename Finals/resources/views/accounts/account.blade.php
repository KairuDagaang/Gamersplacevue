...
<div class='d-grid gap-2 d-md-flex justify-content-md-end mb-3'>
        <a href="{{url('accounts/create')}}" type='button' class='button'>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <a href="{{url('/accounts/'.$account->id)}}" type='button' class='edit'>
                ...
                <button type="button" class="delete" data-bs-toggle="modal" data-bs-target="#deleteAccountModal{{$account->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5 " id="deleteAccountModalLabel">Delete Account #{{$account->id}} - Username: {{$account->ign}}</h1>
