...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('https://cdn.dribbble.com/users/3770240/screenshots/11902405/media/fdd5693ff851f6d3c2d64b61ae9d0a38.gif');
    ...
    <div class='container-fluid'>
        <div class='my-navbar'>
            ...
            <ul>
                ...
                <li><a href='/accountgames'><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-pc-display-horizontal" viewBox="0 0 16 16">
        ...
        @unless(isset($exclude_h1_h2) && $exclude_h1_h2)
        <div class='wrapper'> 
            <h1>Make it to the top!</h1>
            <h2>This is your game</h2>
            <button>Go</button>
        </div>
